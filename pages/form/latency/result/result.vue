<template>
    <view>
        <!--pages/form/latency/result/result.wxml-->
...
export default {
    ...
    methods: {
        ...
        submit: function (e) {
            let that = this;
            uni.request({
                url: app.globalData.globalReqUrl + '/analysis/latency_result/',
                method: 'POST',
                data: {
                    data: {
                        latency: this.latency.uuid,
                        result: this.solution,
                        department_check: this.department_solution.id,
                        respondent_check: this.respondent_solution.person_uuid,
                        department_manage: this.department_manage.id,
                        respondent_manage: this.respondent_manage.person_uuid,
                        date_manage: this.start,
                        date_check: this.due
                    }
                },
...
<style>
/* pages/form/latency/result/result.wxss */
</style>
